...
import { INITIAL_SNS_POSTS } from './snsPosts';
...
export const INITIAL_SNS: SnsState = {
  platforms: [
    ...
    { id: 'NAVER_BLOG',  name: '네이버 블로그', monthlyUsers: 2200, mainAge: '30-50대',  bias: 0,    presidentFavor: 0, desc: '리뷰·정보 중심. 정치적 영향력은 낮음.' },
    ...
    { id: 'THREADS',     name: '스레드',        monthlyUsers: 320,  mainAge: '20-30대',  bias: -10,  presidentFavor: 0, desc: '메타의 X 대항마.' },
